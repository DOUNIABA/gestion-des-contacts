...
function validation(){
    ...
    if(password.value=="" ){
        ...
        password.style.borderWidth='3px';
        img2.innerHTML='<img src="images/checked.png" style="POSITION: relative;top:-49px;right:-395px;width: 39px;">';
        pass.innerHTML="";
    ...
    if(passwordver.value=="" ){
        ...
        passwordver.style.borderWidth='3px';
        img22.innerHTML='<img src="images/checked.png" style="POSITION: relative;top:-49px;right:-395px;width: 39px;">';
        pass2.innerHTML="";
